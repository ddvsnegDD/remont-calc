        ...
        <div className="quiz-wrap">
          <div className="quiz-card">
            ...
            {specResult && hasAccess && (
              <div style={{ marginTop: 28, paddingTop: 24, borderTop: `2px solid ${C.gray200}` }}>
                ...
                <div style={{ fontSize: 12, color: C.gray500, marginTop: 8 }}>
                  Расчёт носит предварительный характер. Уточняется после выезда инженера.
                </div>
              </div>
            )}
            ...
            <div className="result-cta">
              ...
              <p>Личная встреча с руководителем для обсуждения сотрудничества по этому проекту.</p>
