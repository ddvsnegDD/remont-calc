...
export const OFFICE_BUDGET_RAW = {
  standard: [
    ...
    { section: 'general', title: 'Общестроительные работы', subItems: [
      { id: 'partitions', title: 'Перегородки и двери', value: 2300 },
      { id: 'walls', title: 'Отделка стен', value: 12944 },
      { id: 'floors', title: 'Отделка пола', value: 6345 },
      { id: 'ceilings', title: 'Потолки', value: 3784 },
      { id: 'accessories', title: 'Установка аксессуаров', value: 100 },
      { id: 'furniture', title: 'Встраиваемая мебель и бытовая техника', value: 1000 },
    ] },
    { section: 'electrical', title: 'Электрические и слаботочные системы', subItems: [
      ...
      { id: 'lighting', title: 'Система освещения', value: 2000 },
      { id: 'fire_alarm', title: 'Пожарная сигнализация и СОУЭ', value: 2036 },
      { id: 'scs', title: 'СКС и пассивное IT-оборудование', value: 9016 },
      ...
      { id: 'bms', title: 'Система диспетчеризации (BMS)', optional: true, default: false, value: 3150 },
    ] },
    { section: 'mechanical', title: 'Механические системы', subItems: [
      { id: 'ventilation', title: 'Вентиляция', value: 6005 },
      { id: 'climate', title: 'Кондиционирование', value: 3186 },
      { id: 'heating', title: 'Отопление', value: 2000 },
      { id: 'water', title: 'Водоснабжение и канализация', value: 1900 },
      { id: 'fire_pipe', title: 'Противопожарный водопровод', value: 400 },
      { id: 'gas_extinguishing', title: 'Система газового пожаротушения', value: 1185 },
      { id: 'smoke_removal', title: 'Система дымоудаления', optional: true, value: 285 },
    ] },
  ],
  business: [
    { section: 'management', title: 'Управление проектом', value: 4135 },
