          ...
          <div className="quiz-card">
            ...
            <div className="result-hero">
              ...
              <div className="result-disclaimer" style={{ fontWeight: 500 }}>
                <strong>Расчёт носит предварительный характер.</strong> Точная итоговая стоимость
                определяется после выезда инженера на обмер помещений и согласования спецификации материалов.
              </div>
            </div>
            ...
            <div className="alert alert-info" style={{ marginTop: 28 }}>
              <strong>Что дальше?</strong> Инженер РПКМ выезжает на ваш объект бесплатно, делает точные обмеры
              и согласовывает спецификацию материалов. После этого формируется финальная смета с фиксированной ценой.
            </div>

            {/* CTA */}
            <div className="result-cta">
              <h3>Записаться на бесплатный замер</h3>
              <p>Куратор свяжется с вами в течение рабочего дня и согласует удобное время выезда инженера.</p>
              <Btn variant="terra" size="lg" onClick={() => navigate('/b2c-book')}>Записаться на замер</Btn>
            </div>
          </div>
        </div>
      </div>
